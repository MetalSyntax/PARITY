...
// Category metadata without icons (id, name, color only)
export const CATEGORY_META: { id: string; name: string; color: string }[] = [
  { id: 'transfer', name: 'cat_transfer', color: 'bg-indigo-500/20 text-indigo-400' },
  { id: 'food', name: 'cat_food', color: 'bg-orange-500/20 text-orange-400' },
  { id: 'transport', name: 'cat_transport', color: 'bg-blue-500/20 text-blue-400' },
  { id: 'coffee', name: 'cat_fastfood', color: 'bg-red-400/20 text-red-300' },
  { id: 'home', name: 'cat_home', color: 'bg-indigo-500/20 text-indigo-400' },
  { id: 'bills', name: 'cat_bills', color: 'bg-yellow-500/20 text-yellow-400' },
  { id: 'internet', name: 'cat_internet', color: 'bg-sky-600/20 text-sky-400' },
  { id: 'health', name: 'cat_health', color: 'bg-red-500/20 text-red-400' },
  { id: 'entertainment', name: 'cat_entertainment', color: 'bg-purple-500/20 text-purple-400' },
  { id: 'travel', name: 'cat_travel', color: 'bg-sky-500/20 text-sky-400' },
  { id: 'shopping', name: 'cat_shopping', color: 'bg-pink-500/20 text-pink-400' },
  { id: 'education', name: 'cat_education', color: 'bg-emerald-500/20 text-emerald-400' },
  { id: 'gift', name: 'cat_gift', color: 'bg-rose-500/20 text-rose-400' },
  { id: 'investment', name: 'cat_investment', color: 'bg-green-500/20 text-green-400' },
  { id: 'savings', name: 'cat_savings', color: 'bg-emerald-500/20 text-emerald-400' },
  { id: 'pets', name: 'cat_pets', color: 'bg-amber-500/20 text-amber-400' },
  { id: 'kids', name: 'cat_kids', color: 'bg-blue-300/20 text-blue-300' },
  { id: 'insurance', name: 'cat_insurance', color: 'bg-indigo-700/20 text-indigo-400' },
  { id: 'taxes', name: 'cat_taxes', color: 'bg-gray-500/20 text-gray-400' },
  { id: 'vacation', name: 'cat_vacation', color: 'bg-cyan-500/20 text-cyan-400' },
  { id: 'electronics', name: 'cat_electronics', color: 'bg-zinc-500/20 text-zinc-300' },
  { id: 'subscription', name: 'cat_subscription', color: 'bg-violet-500/20 text-violet-400' },
  { id: 'services', name: 'cat_services', color: 'bg-slate-500/20 text-slate-400' },
  { id: 'commission', name: 'cat_commission', color: 'bg-red-600/20 text-red-300' },
  { id: 'personal', name: 'cat_personal', color: 'bg-teal-500/20 text-teal-400' },
  { id: 'charity', name: 'cat_charity', color: 'bg-rose-300/20 text-rose-300' },
  { id: 'income', name: 'cat_income', color: 'bg-emerald-600/20 text-emerald-400' },
  { id: 'work', name: 'cat_work', color: 'bg-slate-600/20 text-slate-300' },
  { id: 'freelance', name: 'cat_freelance', color: 'bg-indigo-400/20 text-indigo-300' },
  { id: 'business', name: 'cat_business', color: 'bg-blue-600/20 text-blue-400' },
  { id: 'interest', name: 'cat_interest', color: 'bg-indigo-600/20 text-indigo-400' },
  { id: 'loans', name: 'cat_loans', color: 'bg-emerald-700/20 text-emerald-500' },
  { id: 'other', name: 'cat_other', color: 'bg-gray-600/20 text-gray-300' },
];

// Template metadata without icons
export const RECURRING_TEMPLATE_META: {
  id: string; name: string; type: TransactionType; category: string; frequency: string;
}[] = [
  { id: 'tpl_salary', name: 'template_salary', type: TransactionType.INCOME, category: 'income', frequency: 'Monthly' },
  { id: 'tpl_rent', name: 'template_rent', type: TransactionType.EXPENSE, category: 'home', frequency: 'Monthly' },
  { id: 'tpl_condominio', name: 'template_condominio', type: TransactionType.EXPENSE, category: 'home', frequency: 'Monthly' },
  { id: 'tpl_corpoelec', name: 'template_corpoelec', type: TransactionType.EXPENSE, category: 'bills', frequency: 'Monthly' },
  { id: 'tpl_electric', name: 'template_electric', type: TransactionType.EXPENSE, category: 'bills', frequency: 'Monthly' },
  { id: 'tpl_hidrocapital', name: 'template_hidrocapital', type: TransactionType.EXPENSE, category: 'bills', frequency: 'Monthly' },
  { id: 'tpl_water', name: 'template_water', type: TransactionType.EXPENSE, category: 'bills', frequency: 'Monthly' },
  { id: 'tpl_cantv', name: 'template_cantv', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_inter', name: 'template_inter', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_movistar_inet', name: 'template_movistar_inet', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_fibex', name: 'template_fibex', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_gigatel', name: 'template_gigatel', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_wow', name: 'template_wow', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_internet', name: 'template_internet', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_mobile_data', name: 'template_mobile_data', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_digitel', name: 'template_digitel', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_movilnet', name: 'template_movilnet', type: TransactionType.EXPENSE, category: 'internet', frequency: 'Monthly' },
  { id: 'tpl_cashea', name: 'template_cashea', type: TransactionType.EXPENSE, category: 'loans', frequency: 'Monthly' },
  { id: 'tpl_weppa', name: 'template_weppa', type: TransactionType.EXPENSE, category: 'loans', frequency: 'Monthly' },
  { id: 'tpl_krece', name: 'template_krece', type: TransactionType.EXPENSE, category: 'loans', frequency: 'Monthly' },
  { id: 'tpl_creditotal', name: 'template_creditotal', type: TransactionType.EXPENSE, category: 'loans', frequency: 'Monthly' },
  { id: 'tpl_efectivoya', name: 'template_efectivoya', type: TransactionType.EXPENSE, category: 'loans', frequency: 'Monthly' },
  { id: 'tpl_hcm', name: 'template_hcm', type: TransactionType.EXPENSE, category: 'insurance', frequency: 'Monthly' },
  { id: 'tpl_gas', name: 'template_gas', type: TransactionType.EXPENSE, category: 'transport', frequency: 'Weekly' },
  { id: 'tpl_netflix', name: 'template_netflix', type: TransactionType.EXPENSE, category: 'subscription', frequency: 'Monthly' },
  { id: 'tpl_streaming_plus', name: 'template_streaming_plus', type: TransactionType.EXPENSE, category: 'subscription', frequency: 'Monthly' },
];
