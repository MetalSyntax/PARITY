...
import { Transaction, TransactionType, Language, Currency, Account } from '@parity/core';
import { getTranslation } from '@parity/i18n';
import { CurrencyAmount } from '../components/CurrencyAmount';
import { formatAmount } from '@parity/core';
import { calculateFiscalYearSummary } from '@parity/core';
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
             ...
             <div>
                ...
                <p className="text-xs text-theme-secondary font-medium">{t('fiscalSubtitle')}</p>
             </div>
          </div>
